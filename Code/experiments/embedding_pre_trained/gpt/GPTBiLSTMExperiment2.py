...
class GPTBiLSTMExperiment2:
    ...
    def build_model_classifier(self, run_number=0):
        ...
        # ceate a picture of the embedding
        picture_name = (
            "GPT_EMBEDDING" + "_" + self.experiment_tag + "_" + str(run_number) + ".png"
        )
        picture_path = os.path.join(self.experiment_result_path, picture_name)

        plot_model(new_model_base, show_shapes=True, to_file=picture_path)
